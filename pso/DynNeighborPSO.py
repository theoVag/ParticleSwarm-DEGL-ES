    ...
    def optimize( self ):
        ...
        while not doStop:
            ...
            for p in range(nParticles):
                ...
                # algorithm can work also for these orders with discrete values 0 and 90 
                # because of the symmetry of orders' parts
                """w3= [b for b in range(2,nVars,3)]
                for k in w3:
                    if self.Swarm[p,k] <45:
                        self.Swarm[p,k] = 0
                    else:
                        self.Swarm[p,k]=90
                        self.Velocity[p,k] = 0.0"""
